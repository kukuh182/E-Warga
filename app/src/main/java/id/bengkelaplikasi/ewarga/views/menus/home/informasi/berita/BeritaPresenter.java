...
public class BeritaPresenter implements Presenter<BeritaView>{

    private BeritaView mView;
    @Override
    public void onAttach(BeritaView view) {
        this.mView = view;
    }
    ...
    public void getListDataToServer(final CallBackData callBack){
        ...
        if(Utilities.isInternetAvailable()){
            ...
            Client.request(service.getBerita(params), new Client.CallBackRequest() {
                @Override
    ...
    private List<InformasiModel> checkResponse(String response) {
        ...
        try{
            ...
            e.printStackTrace();
            mView.showMessage(Constanta.Message.ERR_FAIED_DATA);
        }
        return data;
    }
