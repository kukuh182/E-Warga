...
public class AgendaPresenter implements Presenter<AgendaView>{

    private AgendaView mView;


    @Override
    public void onAttach(AgendaView view) {
        this.mView = view;
    }
    ...
    public void getListDataToServer(final CallBackData callBack){
        ...
        if(Utilities.isInternetAvailable()){
            ...
            Client.request(service.getAgenda(params), new Client.CallBackRequest() {
                @Override
