...
public class GPSTracker extends Service implements LocationListener {
    ...
    private String [] permission = {Permissions.Location.ACCESS_COARSE_LOCATION, Permissions.Location.ACCESS_FINE_LOCATION};
    ...
    public Location getLocation() {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                //System.out.println("onLocationChanged.." + isGPSEnabled);
            } else {
                this.canGetLocation = true;
                //System.out.println("onLocationChanged.." + " Masuk " + isGPSEnabled);
                ...
                if (isNetworkEnabled) {
                    //Log.e("LONGLAT","Network Provider");
                    if(Utilities.checkPermission(activity, permission)){
